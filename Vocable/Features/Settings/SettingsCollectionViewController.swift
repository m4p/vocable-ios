...
//            let alertViewController = GazeableAlertViewController(title: "Title")
...
//            alertViewController.addAction(GazableAlertAction(title: "Screw it, going back to bed", handler: nil))
        ...
        case .contactDevs:
            let alertViewController = GazeableAlertViewController(
                alertTitle: "You're about to be taken outside of the Vocable app. You may lose head tracking control."
               )
            present(alertViewController, animated: true)
